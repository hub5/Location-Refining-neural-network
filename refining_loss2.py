...
def wrapper_test(model):
    ...
    while index<test_num:
        ...
        vmse = metric.valid_mse(img_gen[:, -1] * 80, dat[:, -1] * 80,20)
    ...
    for itr in range(1, 2*args.max_iterations + 1):
        ...
        if itr % args.test_interval == 0:
            ...
            if(test_epoch<30):
                ...
                save_path = '/home/ices/HX/rainfall_final/model_new/refining/refining_new2/' + 'refining' + str(test_epoch) + '.pkl'
